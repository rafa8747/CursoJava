...
public class CursoDAO {
	...
	public Curso findById(java.math.BigDecimal id) {
		log.debug("getting Curso instance with id: " + id);
		try {
			Curso instance = (Curso) sessionFactory.getCurrentSession().get("com.abctreinamentos.Curso", id);
			if (instance == null) {
	...
	public List findByExample(Curso instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.abctreinamentos.Curso")
